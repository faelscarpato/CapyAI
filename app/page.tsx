...
import { ArrowRight, Bot, Sparkles, Users, Zap, Code, Eye } from "lucide-react"
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Powerful IDE Experience</h2>
            <p className="text-lg text-gray-600">
              Build, test, and deploy your applications with our integrated development environment
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">See your changes in real-time with our responsive preview panel</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Get help with coding, debugging, and optimization from our AI assistant</p>
            </div>
          </div>
